// ARQUIVO DE TESTE - EXECUTANDO DOMCASMURRO 100 VEZES EM CADA DICIONÀRIO
#include <iostream>
...
int main(){
    ...
    ofstream testOut("teste1-dom-casmurro.txt");
    if (!testOut.is_open()) {
    ...
    for (int i = 0; i < 100; i++) {
        ...
        ifstream file("../files/dom-casmurro.txt");
        cout << "Tentando abrir o arquivo: " << "DOMCASMURRO" << endl;
    ...
    testOut << "Tempo médio de execução AVL para DOMCASMURRO: " << avgTime << " segundos" << endl;
    ...
    testOut << "Tempo médio de execução RB para DOMCASMURRO: " << avgTime << " segundos" << endl;
    ...
    testOut << "Tempo médio de execução ChainedHash para DOMCASMURRO: " << avgTime << " segundos" << endl;
    ...
    testOut << "Tempo médio de execução OpenHash para DOMCASMURRO: " << avgTime << " segundos" << endl;
