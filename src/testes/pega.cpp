// ARQUIVO DE TESTE - EXECUTANDO PEGATERNOREI 100 VEZES EM CADA DICIONÀRIO
#include <iostream>
...
int main(){
    ...
    ofstream testOut("teste1-pega-terno-rei.txt");
    if (!testOut.is_open()) {
    ...
    for (int i = 0; i < 100; i++) {
        ...
        ifstream file("../files/pega-terno-rei.txt");
        cout << "Tentando abrir o arquivo: " << "PEGATERNOREI" << endl;
    ...
    testOut << "Tempo médio de execução AVL para PEGATERNOREI: " << avgTime << " segundos" << endl;
    ...
    testOut << "Tempo médio de execução RB para PEGATERNOREI: " << avgTime << " segundos" << endl;
    ...
    testOut << "Tempo médio de execução ChainedHash para PEGATERNOREI: " << avgTime << " segundos" << endl;
    ...
    testOut << "Tempo médio de execução OpenHash para PEGATERNOREI: " << avgTime << " segundos" << endl;
