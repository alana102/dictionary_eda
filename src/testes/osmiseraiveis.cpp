// ARQUIVO DE TESTE - EXECUTANDO OS_MISERAVEIS 100 VEZES EM CADA DICIONÀRIO
#include <iostream>
...
int main(){
    ...
    ofstream testOut("teste1-os-miseraveis.txt");
    if (!testOut.is_open()) {
    ...
    for (int i = 0; i < 100; i++) {
        ...
        ifstream file("../files/os-miseraveis.txt");
        cout << "Tentando abrir o arquivo: " << "OS_MISERAVEIS" << endl;
    ...
    testOut << "Tempo médio de execução AVL para OS_MISERAVEIS: " << avgTime << " segundos" << endl;
    ...
    testOut << "Tempo médio de execução RB para OS_MISERAVEIS: " << avgTime << " segundos" << endl;
    ...
    testOut << "Tempo médio de execução ChainedHash para OS_MISERAVEIS: " << avgTime << " segundos" << endl;
    ...
    testOut << "Tempo médio de execução OpenHash para OS_MISERAVEIS: " << avgTime << " segundos" << endl;
